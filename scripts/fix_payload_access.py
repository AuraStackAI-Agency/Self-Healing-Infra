#!/usr/bin/env python3
"""Fix Normaliser Payload to correctly access webhook body data"""
import requests
import json
...
# Fix Normaliser Payload to access body correctly
for node in w['nodes']:
...
return [{ json: payload }];'''
        print("[OK] Fixed Normaliser Payload - now reads from body")
