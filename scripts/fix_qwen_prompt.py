#!/usr/bin/env python3
"""Fix Qwen prompt to generate clean commands without alternatives"""
import requests
import json
...
# Fix Qwen prompt to generate cleaner commands
for node in w['nodes']:
...
return [{ json: { ...incident, _ollama_payload: ollamaPayload } }];'''
        print("[OK] Fixed Qwen prompt for clean commands")
